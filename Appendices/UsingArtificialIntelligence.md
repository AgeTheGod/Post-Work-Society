...
For the analysis of Wealth the prompts I used were...
    ...
    How much personal wealth in the UK is held in financial vehicles such as pension schemes, ISA, Trusts etc?
    ...By Population Percentage
    ...By Age Group
    ...By Financial Vehicle And Age Group
    ...By Income Bracket
...
For the analysis of Inheritance Tax the prompts I used were...
    ...
    What alternative Inheritance Tax frameworks are there?
    What are the Pros and Cons of the different frameworks?
    How would it affect the results if Inherited Wealth had been taxed as income?
...
Universal Basic Income
    ...
    In which article or publication did Milton Friedman state his support for Universal Basic Income?
    What was the basic premise of Keynesisn Economics?
    How much would Universal Basivc Income cost the UK if restricted to working age people?
    How much if extended to everyone?
    What expenses are covered by the Minimum Income Standard payment?
    How does that break down in monetary terms?
    How much if paid using cost of production rather than commercial costs for each expense i.e. removing profit margins?
    How does a Universal Basic Services model compares politically to a cash UBI?
