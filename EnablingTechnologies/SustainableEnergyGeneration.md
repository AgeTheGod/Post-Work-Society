...
Energy generation is a critical enabling technology (some wopuld say the single most important requirement) and when we talk about Energy Generation we're really talking about "Electricity" because that's what powers pretty much everything that most of us care about.

Fortunately, because of the current focus on "Renewable Energy" and "Sustainable Energy", this is an area that has been exploding wioth new technologies in recent years to the externt that 100% rebnewable and susteainable eleectricity generation is pretty much a reality. 
Some Countries are already there (e.g. Costa Rica, Iceland, Norway) and many more, including the UK, are on the way and the cost of renewable energy is now cheaper than fossil fuels in many parts of the world.

Even better, most of that cost is capital investment in infrastructure, i.e. initially building the things we need, and once built the on-going maintenance of renewable energy generation is significantly lower due to the durability of modern materials, such as ceramics, compared to historically significant  materials. 

Energy management is a three part problem...
...
however, even though Nuclear Fission is still being pursued what is changing is the switch away from Uranium towards Thorium Nuclear Reactors.
...
####    Droplet Electricity Generators (DEG)
...
The mechanics driving this rely on a breakthrough in droplet-based electricity generators (DEGs). 
When a raindrop hits the specially coated panel, it bridges two electrodes. 
This creates a closed-loop system that instantly releases the droplet's naturally stored surface charge.
Earlier versions of this tech barely generated enough power to register. 
The new material design increases energy yield by orders of magnitude. 
The goal isn't just to power a few lights—it's to turn the monsoon season into a measurable offset for an entire skyscraper's energy load.
...
You do not plug it in. You do not replace the batteries. A Chinese tech start-up has just begun manufacturing a commercial nuclear battery smaller than a coin. The Betavolt BV100 sandwiches a microscopic layer of radioactive nickel-63 between two diamond semiconductors. As the nickel decays, it generates an electrical current for 50 straight years without stopping. The detail nobody talks about is what happens when it is done. It does not become nuclear waste. The nickel gradually degrades into completely harmless, stable copper. Right now it produces 100 microwatts. The long-term goal is scaling it to power a smartphone for its entire lifespan.
