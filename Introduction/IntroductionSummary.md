...
- ... and how we will measure success i.e. whether we have chieved what wer set out to do or not 
...
The [Principles](./Principles.md) section outlines "**Non-Functional Requirements**" (a term used widely in Application Development Methodologies) that should apply to any proposed solution.
