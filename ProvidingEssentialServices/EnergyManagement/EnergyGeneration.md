...
- It is very cost-effective once the Nuclear Power Station is built and has one of the lowest "_operational costs per KWh/H_" ampongst all the sustainable energy generation technologies. (On the other hand, the Capital Investment cost is very high in comparison)    
...
Fusion Reactors are a type of nuclear reactor that is designed to generate electricity from nuclear fusion reactions (as oppopsed to traditional Fission Reactors that split Atoms).
