...
Finally, although not an essential part of creating a Post Work Society there are [further implications](FurtherImplications/FurtherImplications.md) to doing so including a certain amount of [Social Reform](ReformingSociety/SocialReform/SocialReformSummary.md) to establish the expectations that Citizens should have about the Society in which they live (or propose to live in).
