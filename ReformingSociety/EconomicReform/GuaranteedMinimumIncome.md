...
Guaranteed Minimum Income (GMI) systems ensure no individual falls below a defined standard of living. 

They differ from unconditional Universal Basic Income (UBI) by focusing assistance on those in need, often requiring recipients to seek work or have incomes below a set threshold.

The primary models of Guaranteed Minimum Income proposed over the decades include:
